...
app.post('/owner/direct-action', requireLogin, requireOwner, (req, res) => {
    ...
    if (actionType === 'ban') {
        ...
        switch(banDuration) {
            ...
            case '30m': ms = 30*60*1000; logText = "30 phút"; break;
            case '1h': ms = 60*60*1000; logText = "1 giờ"; break;
            case '12h': ms = 12*60*60*1000; logText = "12 giờ"; break;
            case '24h': ms = 24*60*60*1000; logText = "1 ngày"; break;
            case '7d': ms = 7*24*60*60*1000; logText = "7 ngày"; break;
            case 'forever': default: ms = -1; logText = "Vĩnh viễn"; break;
        }
